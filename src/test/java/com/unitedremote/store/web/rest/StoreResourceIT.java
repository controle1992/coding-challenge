...
import static com.unitedremote.store.web.rest.TestUtil.createFormattingConversionService;
...
public class StoreResourceIT {
    ...
    public void createStore() throws Exception {
        ...
        assertThat(testStore.getPictureUrl()).isEqualTo(DEFAULT_PICTURE_URL);
    ...
    public void updateStore() throws Exception {
        ...
        assertThat(testStore.getPictureUrl()).isEqualTo(UPDATED_PICTURE_URL);
